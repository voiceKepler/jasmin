  ...
  return (
    <div>
      ...
      <div className='local-professionnel container'>
        ...
        <p className='w-50'>Si vous répondez oui à l'une de ces questions, il est peut-être temps d'envisager une rénovation de votre logement. Que vous ayez besoin de <span className='weight-600'>petits travaux de rénovation</span> ou d'une <span className='weight-600'>rénovation complète</span>, nous sommes là pour vous accompagner dans votre projet de rénovation de A à Z.</p>
